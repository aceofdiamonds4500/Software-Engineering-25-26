"""Comprehensive diagnostic script for model and data validation"""
import sys
import os
...
import numpy as np
import pandas as pd
from backend.ai.data import load_medical_data, preprocess_dataframe, serialize_specialty
...
if df.medical_specialty.nunique() != config.NUM_LABELS:
    print(f"⚠️  WARNING: Expected {config.NUM_LABELS} classes, found {df.medical_specialty.nunique()}")
